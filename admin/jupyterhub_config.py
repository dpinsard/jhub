...
# c.Spawner.args = ['--config=/home/vagrant/.jupyter/jupyter_notebook_config.py']
...
c.Spawner.env_keep = ['PATH', 'LANG', 'LC_ALL',
     'CAML_LD_LIBRARY_PATH', 'PERL5LIB',
     'JUPYTER_CONFIG_DIR', 'OCAML_TOPLEVEL_PATH']
