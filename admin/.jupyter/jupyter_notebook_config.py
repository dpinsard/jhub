...
#~ c.NotebookApp.ip = '172.16.112.89'
...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/home/denis/.config/ipython'
...
#c.NotebookApp.extra_static_paths = ['/home/vagrant/.jupyter']
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/home/denis/.config/ipython'

# Configure matplotlib for interactive use with the default matplotlib backend.
c.TerminalIPythonApp.matplotlib = 'inline'
...
c.TerminalIPythonApp.extensions = ['pep8_magic', 'sql', 'autoreload']
...
c.InlineBackend.rc = {'font.size': 10, 'figure.figsize': (10.0, 8.0), 'figure.facecolor': 'white', 'savefig.dpi': 72, 'figure.subplot.bottom': 0.125, 'figure.edgecolor': 'white'}
